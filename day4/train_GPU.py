...
train_data = ImageTxtDataset(
    r"G:\Internship\Day3\train.txt",
    r"G:\Internship\Day3\images\train",
    transforms.Compose([
...
test_data = ImageTxtDataset(
    r"G:\Internship\Day3\val.txt",
    r"G:\Internship\Day3\images\val",
    transforms.Compose([
        transforms.Resize(224),
        transforms.RandomHorizontalFlip(),
        transforms.ToTensor(),
...
# 创建网络模型
model = AlexNet(num_classes=100)  # 确保与数据集标签匹配
